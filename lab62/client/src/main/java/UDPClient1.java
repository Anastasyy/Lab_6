...
public class UDPClient1 {
    ...
    public UDPClient1(String host, int port, SingleCommandResolvingService resolver) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        Printer printer = new ConsolePrinter();  // replace with your actual Printer implementation
        ...
        UDPClient1 client = new UDPClient1("localhost", 8888, resolver);
        client.start();
    }
}
